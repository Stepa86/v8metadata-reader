...
Процедура ОпределитьТипВыгрузки()
	...
	_ЭтоВыгрузкаКонфигуратора = ОбщегоНазначения.ЭтоВыгрузкаКонфигурации( _КаталогИсходников );
	_ЭтоВыгрузкаЕДТ = ОбщегоНазначения.ЭтоВыгрузкаЕДТ( _КаталогИсходников );	
