...
Функция ОбъектыПодсистем(Знач пПодсистемы,
	...
	Для каждого цПодсистема Из пПодсистемы Цикл
		...
		подсистема = ЗначениеСтруктуры(составПодсистем, цПодсистема);
		
		Если подсистема = Неопределено Тогда
			
			_лог.Ошибка("Подсистема <%1> не найдена.", цПодсистема);
			Продолжить;
			
		КонецЕсли;
		
		объекты = подсистема._Объекты_;
	...
	Для каждого цПодсистема Из ОбеспечитьМассив(пПодсистемыСПодчиненными) Цикл
		...
		объекты = подсистема._ОбъектыСПодчиненными_;
	...
	Для каждого цПодсистема Из ОбеспечитьМассив(пПодсистемыСРодителями) Цикл
		...
		объекты = подсистема._ОбъектыСРодителями_;
